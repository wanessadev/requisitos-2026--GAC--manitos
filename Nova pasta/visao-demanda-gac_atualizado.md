...
#### F3.1 Solicitação de devolução

- **Descrição:** permite que o professor solicite a devolução do ativo ao final do uso ou do turno letivo, iniciando o fluxo de conferência.
- **Incluída**
- **Atores:** Professor
- **Frequência:** Alta
- **Valor:** Alto

#### F3.2 Registro de devolução e checklist
